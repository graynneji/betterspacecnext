  ...
  return (
    <PrivacyContent>
      <PrivacyContainer>
        <PrivacyContainerContent>
          <PrivacyHeader>
            <PrivacyHeaderText>Terms & Condition</PrivacyHeaderText>
            <PrivacyHeaderSubText>
              Last Updated: March 23rd, 2024 (Version 1.1.1)
            </PrivacyHeaderSubText>
          </PrivacyHeader>
          ...
          <PrivacyList>
            <li>
              <PrivacyParagraph>
                <strong>Application</strong> means the digital distribution
                service operated and developed by Apple Inc. (Apple App Store)
                or Google Inc. (Google Play Store) in which the Application has
                been downloaded.
              </PrivacyParagraph>
            </li>
            <li>
          ...
          <sapn style={{ textAlign: "center" }}>
            <h3>
              {" "}
              &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; <br />
              Disclaimer
            </h3>
          </sapn>
          ...
          <PrivacyList>
            <li>By email: help@betterspace.ng</li>
            <li>
